...
activities = {
    ...
    "Soccer Team": {
        "description": "Work on soccer skills and compete in interschool matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "maria@mergington.edu"]
    },
    "Swim Club": {
        "description": "Practice swimming techniques and train for relay meets",
        "schedule": "Mondays and Wednesdays, 3:45 PM - 5:15 PM",
        "max_participants": 18,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Drama Club": {
        "description": "Develop acting skills and prepare school theater productions",
